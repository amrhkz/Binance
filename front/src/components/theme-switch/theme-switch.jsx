...
function ThemeSwitch() {
  function darkMode() {
    document.querySelector("body")?.classNameList.toggle("light");
  }
  return (
    <div
    ...
    >
      <svg
        className="bn-svg theme-icon moon hover-color"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
        <symbol viewBox="0 0 24 24" id="e4c31cb6-87e6-4bb1-a84d-37620b577bea">
          <path
        ...
        <use href="#e4c31cb6-87e6-4bb1-a84d-37620b577bea" />
      </svg>
      <svg
        className="bn-svg theme-icon sun hover-color"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
        <symbol viewBox="0 0 24 24" id="94146747-9abf-46bb-9b2a-b5f837b18cf2">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <use href="#94146747-9abf-46bb-9b2a-b5f837b18cf2" />
      </svg>
    </div>
  );
}
